...
package me.khanghoang.smartinv.content;
...
public interface Pagination {
    ...
    /**
     * Sets the maximum available slots per page.
     *
     * @param slotsPerPage the maximum amount of items per page
     * @return <code>this</code>, for chained calls
     */
    Pagination setSlotsPerPage(int slotsPerPage);
    ...
    class Impl implements Pagination {
        ...
        public boolean isLast() {
            int pageCount = (int) Math.ceil((double) this.items.length / this.slotsPerPage);
        ...
        public Pagination last() {
            this.currentPage = this.items.length / this.slotsPerPage;
            return this;
        }
        ...
        @Override
        public Pagination setSlotsPerPage(int slotPerPage) {
